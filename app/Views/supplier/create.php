        ...
        <div class="card" style="width: 32rem;">
          <div class="card-body">
            <div class="card-header bg-success">
              ...
              <h4 class="mt-4"> Tambah Data Supplier</h4>
            </div>
            <form style="width:450px" class="mt-4" action="/supplier/save" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group row ">
                ...
                <div class="col-sm-8">
                  <input type="nomor_telp" class="form-control" id="nomor_telp" name="nomor_telp">
                </div>
              </div>
